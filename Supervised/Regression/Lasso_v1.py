...
# -*- coding: utf-8 -*-
"""
Created on Mon Sep 23 12:53:58 2019
...
# 2 Lasso
mod_lasso = LassoCV(alphas = [0.0001, 0.0003, 0.0006, 0.001, 0.003, 0.006, 0.01, 0.03, 0.06, 0.1, 
                          0.3, 0.6, 1], 
...
mod_lasso = LassoCV(alphas = [alpha * .6, alpha * .65, alpha * .7, alpha * .75, alpha * .8, 
...
coefs = pd.Series(mod_lasso.coef_, index = df.iloc[:,4:].columns)
