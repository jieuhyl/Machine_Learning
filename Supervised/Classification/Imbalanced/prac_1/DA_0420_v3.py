# -*- coding: utf-8 -*-
"""
Created on Mon Apr 20 18:05:53 2020
...
parameters = {'kernel': ['linear'], 
              ...
              'class_weight':[{0:3,1:1}, {0:2,1:1}, {0:1,1:1}, {0:1,1:2}, {0:1,1:3}, 'balanced', None]}
...
sub = pd.DataFrame({"Attribute": df.iloc[:, 2:].columns, 
                    "Coefficient": clf_svc.coef_[0]}).sort_values(by='Coefficient', ascending=False)
sub.to_csv('C:/Users/Jie.Hu/Desktop/Driver Analysis/0420/DA_outputs_svc.csv', index=False)
