# -*- coding: utf-8 -*-
"""
Created on Mon Aug 24 23:04:23 2020
...
df_ans = df.copy()
df_ans.loc[df_ans.ID.isin(ans), 'Target'] = 2
df_ans['Target'] = df_ans['Target'].map({1:'Seed', 2:'Recommend', 0:'Other'})
...
nca = NeighborhoodComponentsAnalysis(n_components=2, random_state=1234)
result = nca.fit_transform(X, y)

df_ans['D1'] = result[:, 0]
df_ans['D2'] = result[:, 1]

# export
file_name = 'Visualize_' + now_time
export_path = path + file_name + '.png'

plt.figure(figsize=(12, 9))
sns_plot = sns.scatterplot(x="D1", y="D2", hue="Target", data=df_ans)
#plt.legend(bbox_to_anchor=(1.05, 1), loc=2, borderaxespad=0)
sns_plot.figure.savefig(export_path)
